...
// This would be similar to how it is in v1:
/*
...
*/
// However, it would be reworked to support the v2 adapters + extensions approach.
// It would likely import adapters from .discraft/adapter-node/index.ts for example, by using the @discraft/_core package for example.
